...
post-degree diploma in Information and Communication Technology. I am a former employee of Infosys Ltd. 
...
I have done a small Andriod project and have a basic knowledge of andriod. I have also worked on writing JMX plugins for nagios and therefore,
...
const projectTitle = React.createElement("h1", {style:{textAlign: 'center'},key: "projectTitle", id: "projectTitle"}, "Projects");
        ...
        const project2 = [`Single handedly created entire flow of Registration form using JSP, Spring Framework Model View Controller. I have written validations for each field. I have used
                        Apis to fetch data.`];
        const project2List = [];
        const projectArray = [["img/exp1.jpg", "Daymon","AWS Cloud Platform", "US Based Sales and Marketing Client", project1, project1List],
                        ["img/exp2.jpg","Coach Portal","Spring MVC Framework", "US Based Coaching Client", project2, project2List]];
...
const expTitle = React.createElement("h1", {style:{textAlign: 'center'},key: "expTitle", id: "expTitle"}, "Experience");
        ...
        const expArray = [[ "DevOps Engineer","Infosys Ltd.", "August 2018 – July 2020", exp1],
                        ["Full-stack Developer","Infosys Ltd.", "July 2017 – July 2018", exp2]];
